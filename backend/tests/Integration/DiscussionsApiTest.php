...
class DiscussionsApiTest extends TestCase
{
    ...
    {
        $response = $this->request('GET', 'discussions.php?subject_id=1', $this->studentToken);
        $this->assertEquals(200, $response['status']);
    }

    public function testCreateThread()
    {
        $response = $this->request('POST', 'discussions.php', $this->studentToken, [
            'subject_id' => 1,
