...
class ImportApiTest extends TestCase
{
    ...
    public function testImportStudentsRequiresMultiPart()
    {
        // Testing with JSON should fail because it expects multipart/form-data
        $response = $this->request('POST', 'import.php?type=students', $this->adminToken, []);
